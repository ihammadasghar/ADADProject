              ...
              <Card.Body>
                ...
                <div className="best-events-list">
                  {bestRatedEvents.map((event, index) => {
                    const eventId = event._id || event.id || event.eventId || (event._id && event._id.$oid) || index;
                    return (
                      <Link
                        to={`/events/${eventId}`}
                        key={eventId}
                        className="best-event-item d-flex align-items-center"
                        ...
                        <div className="event-info">
                          ...
                          <div className="event-meta">
                            ...
                            <span className="event-date">
                              {event.changeDate ? formatDate(event.changeDate) : "No date"}
                            </span>
                          </div>
                        </div>
